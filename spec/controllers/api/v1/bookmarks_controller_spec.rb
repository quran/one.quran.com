...
RSpec.describe Api::V1::BookmarksController, type: :controller do
  ...
  # Api::V1::BookmarksController. Be sure to keep this updated too.
  let(:valid_session) { {} }
  ...
  describe "GET #show" do
    it "assigns the requested api_v1 as @api_v1" do
      ...
      expect(assigns(:api_v1)).to eq(bookmark)
    end
  end
  ...
  describe "GET #new" do
    it "assigns a new api_v1 as @api_v1" do
      ...
      expect(assigns(:api_v1)).to be_a_new(Bookmark)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "assigns a newly created api_v1 as @api_v1" do
        post :create, params: {api_v1: valid_attributes}, session: valid_session
        expect(assigns(:api_v1)).to be_a(Bookmark)
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested api_v1" do
        bookmark = Bookmark.create! valid_attributes
        put :update, params: {id: bookmark.to_param, api_v1: new_attributes}, session: valid_session
        bookmark.reload
      ...
      it "assigns the requested api_v1 as @api_v1" do
        bookmark = Bookmark.create! valid_attributes
        put :update, params: {id: bookmark.to_param, api_v1: valid_attributes}, session: valid_session
        expect(assigns(:api_v1)).to eq(bookmark)
      end
    ...
    context "with invalid params" do
      it "assigns the api_v1 as @api_v1" do
        bookmark = Bookmark.create! valid_attributes
        put :update, params: {id: bookmark.to_param, api_v1: invalid_attributes}, session: valid_session
        expect(assigns(:api_v1)).to eq(bookmark)
      end
